...
<template>
  <div class="flex min-h-full flex-1 flex-col justify-center px-6 py-12 lg:px-8">
    <div class="sm:mx-auto sm:w-full sm:max-w-sm">
      <img class="mx-auto h-10 w-auto" src="https://cdn-icons-png.flaticon.com/512/1/1560.png" alt="Your Company" />
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
      ...
      <form class="space-y-6">
        ...
        <!-- Sign Up Button -->
        <div>
          <button @click.prevent="handleRegister" class="flex w-full justify-center rounded-md bg-gray-900 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-gray-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600">Sign Up</button>
        </div>
      </form>
    </div>
  </div>
